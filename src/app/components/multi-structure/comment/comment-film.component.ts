...
import { ICommentFilmResponse } from '../../../models/InterfaceResponse';
import { CommentService } from '../../../services/api-service/comment.service';
...
@Component({
  selector: 'app-comment-film',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './comment-film.component.html',
  styleUrls: ['./comment-film.component.scss'],
})
export class CommentFilmComponent implements OnInit {
